  ...
  return (
    <main className="projects-page">
      ...
      <div className="project-container">
        ...
        <ProjectCard title="Thordle" external slug="https://github.com/kurtisgrant/thordle">is an adaptation of the word puzzle game Wordle. In addition as core gameplay logic, Thordle features complex conditional rendering, state management and CSS animations. It also supports light/dark mode and local storage of user stats. (React, Styled-Components, Framer Motion)</ProjectCard>
